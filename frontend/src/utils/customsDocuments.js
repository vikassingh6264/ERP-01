...
export const generateCustomsDeclaration = (shipment, order, inquiry) => {
  ...
  doc.setFont(undefined, 'normal');
  doc.text('ChemExport Trading & Export Company', 20, 67);
...
export const generateCertificateOfOrigin = (shipment, order) => {
  ...
  doc.setFont(undefined, 'normal');
  doc.text('ChemExport Trading & Export Company', 20, 77);
  ...
  doc.setFontSize(10);
  doc.setFont(undefined, 'bold');
  doc.text('For ChemExport Trading & Export Company', 20, finalY + 40);
...
export const generateMSDS = (order, inquiry) => {
  ...
  doc.text('Supplier: ChemExport Trading & Export Company', 25, 70);
...
export const generateBRC = (payment, order, shipment) => {
  ...
  doc.setFont(undefined, 'normal');
  doc.text('Name: ChemExport Trading & Export Company', 20, 107);
...
export const generateFIRCSummary = (payments, startDate, endDate) => {
  ...
  doc.setFont(undefined, 'normal');
  doc.text('ChemExport Trading & Export Company', 20, 65);
